...
import { fetchMarketWanteds } from '../../../actions/MarketWantedActions';
import validate from './MarketWantedSearchFormValidationRules';
import queryString from 'query-string';

const MarketWantedSearchForm = props => {
  ...
  function searchItems() {
    ...
    dispatch(fetchMarketWanteds(search, by, 1, pagination.itemsPerPage));
  }
...
export default MarketWantedSearchForm;