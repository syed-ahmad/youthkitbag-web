...
import { fetchMarketTrades } from '../../../actions/MarketTradeActions';
import validate from './MarketTradeSearchFormValidationRules';
import queryString from 'query-string';

const MarketTradeSearchForm = props => {
  ...
  function searchItems() {
    ...
    dispatch(fetchMarketTrades(search, by, 1, pagination.itemsPerPage));
  }
...
export default MarketTradeSearchForm;