...
class KitCreate extends React.Component {
  ...
  renderSlimTextInput({ input, label, col, type }) {
    return (
                ...
                <div className="col-12 col-lg-6 order-2 order-lg-1" role="main">
                  ...
                  <h3 className="h6">Purchased (all optional)</h3>
                    <div className="form-row">
                      <Field name="purchasedfrom" component={this.renderSlimTextInput} col="4" label="From" type="text" />
                      <Field name="purchasedquantity" component={this.renderSlimTextInput} col="2" label="Quantity" type="number" />
                      <Field name="purchasedondate" component={this.renderSlimTextInput} col="4" label="On" type="date" />
                      <Field name="purchasedprice" component={this.renderSlimTextInput} col="2" label="Price" type="number" step=".01" />
                    </div>
                    <hr />
