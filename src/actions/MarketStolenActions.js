...
import { FETCH_MARKET_STOLENS, FETCH_MARKET_STOLEN, API_MARKET_ERROR, GETALL_FAILURE, RESET_TOAST } from './types';
import history from '../helpers/history';

const baseUrl = process.env.REACT_APP_YKBAPI || 'http://localhost:8080';

export const fetchMarketStolens = (search = '', by = 'all', page = 1, pagesize = 24) => dispatch => {
  axios.get(`${baseUrl}/market/stolen`, {
...
export const fetchMarketStolen = (stolenId) => dispatch => {
  ...
  axios.get(`${baseUrl}/market/stolen/${stolenId}`, {
    headers: {
