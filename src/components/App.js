        ...
        <Router history={history}>
          ...
          <main>
            ...
            <Switch>
              ...
              <PrivateRoute path="/settings/groups/:groupId/members/:memberId/:state" exact component={GroupMemberState} />
              ...
              <PrivateRoute path="/settings/account/profile" exact component={ProfilePage} />
            </Switch>
          </main>
          <Footer />
        </Router>
